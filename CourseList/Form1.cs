...
namespace CourseList
{
    public partial class CourseListForm : Form
    {
        public CourseListForm()
        {
            ...
            courseListView.ItemActivate += new EventHandler(CourseListView__ItemActivate);
            ...
            KeyDown += new KeyEventHandler(CourseListView__KeyDown);
            ...
            courseListView.SelectedIndexChanged += new EventHandler(CourseListView__SelectedIndexChanged);
        ...
        private void CourseListForm_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            ListView lv = this.courseListView;
            ...
            if(firstCourseCode != null)
            {
                ...
                int firstCourseCodeIndex = Globals.courses.sortedList.IndexOfKey(firstCourseCode);
