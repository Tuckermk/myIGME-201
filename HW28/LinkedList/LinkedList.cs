    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            string[] words =
               { "the", "fox", "jumped", "over", "the", "dog" };
            LinkedList<object> linkedList = new LinkedList<object>(words);
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string[] words =
               { "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "a", "room", "without", "a", "roof", "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "sadness", "is", "the", "truth", "sad" };
            ...
            while (linkedListNode != null)
            {
                ...
                if ((string)linkedListNode.Value == "sadness") { linkedListNode.Value = "happiness"; }
                linkedListNode = linkedListNode.Next;
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            LinkedListNode<object> nodeTemp;
            string[] s = null;
            ...
            nodeTemp = linkedList.Find("The");
            linkedList.Remove(linkedListNode1);
            linkedList.AddAfter(nodeTemp, linkedListNode2.Value);

            nodeTemp = linkedList.Find("in");
            linkedList.Remove(linkedListNode2);
            linkedList.AddAfter(nodeTemp, linkedListNode1.Value);

            linkedListNode1 = linkedList.Find("plain");
            linkedListNode2 = linkedList.Find("mainly");

            nodeTemp = linkedList.Find("falls");
            linkedList.Remove(linkedListNode1);
            linkedList.AddAfter(nodeTemp, linkedListNode2.Value);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            nodeTemp = anagram.Find("D");
            linkedListNode1 = anagram.Find("O");
            linkedListNode2 = anagram.Find("I");
            anagram.Remove(linkedListNode1);
            anagram.AddAfter(nodeTemp, linkedListNode2.Value);
            nodeTemp = anagram.FindLast("O");
            anagram.Remove(linkedListNode2);
            anagram.AddAfter(nodeTemp, linkedListNode1.Value);
            //DIRMTOORY
            linkedListNode1 = anagram.Find("Y");
            
            anagram.Remove(linkedListNode1);
            anagram.AddBefore(nodeTemp, linkedListNode1.Value);
            ...
            anagram.AddBefore(nodeTemp, linkedListNode1.Value);
            anagram.Remove(linkedListNode2);
            anagram.AddLast(linkedListNode2.Value);
