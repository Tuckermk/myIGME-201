...
namespace Hw21
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            mSSansSerifToolStripMenuItem.Click += new EventHandler(mSSansSerifToolStripMenuItem_Click);
            timesNewRomanToolStripMenuItem.Click += new EventHandler(timesNewRomanToolStripMenuItem_Click);

            richTextBox.SelectionChanged += new EventHandler(richTextBox_SelectionChanged);

            testToolStripButton.Click += new EventHandler(testToolStripButton_Click);
