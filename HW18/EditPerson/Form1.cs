    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            this.froshRadioButton.CheckedChanged += new EventHandler(classRadioButton_CheckedChanged);
            this.sophRadioButton.CheckedChanged += new EventHandler(classRadioButton_CheckedChanged);
            this.juniorRadioButton.CheckedChanged += new EventHandler(classRadioButton_CheckedChanged);
            this.seniorRadioButton.CheckedChanged += new EventHandler(classRadioButton_CheckedChanged);
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            else if (this.himRadioButton.Checked)
            {
            ...
            else if (this.froshRadioButton.Checked)
            {
