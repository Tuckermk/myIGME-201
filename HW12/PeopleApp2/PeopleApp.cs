    ...
    class PeopleApp
    {
                    ...
                    case "list":
                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                foreach(string course in student.CourseList)
                                {
                                    //Dont know how to complete this due to not
                                    //knowing how to reference anything else about the course
                                    //couldnt figure it out in 3hrs of searching and testing with a splitting headache
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                string sCourseCode = "do";
                do
                {
                    Console.Write($"Course code => ");
                    sCourseCode = Console.ReadLine();
                    if (sCourseCode.Length > 0)
                    {
                        thisStudent.courseCodes.Add(sCourseCode);
                    }
                } while (sCourseCode.Length > 0);
            }
